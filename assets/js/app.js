        ...
        return `
            <div class="car-card" data-class="${car.class}" data-trans="${car.transmission}" data-fuel="${car.fuel}">
                ...
                <div class="car-content">
                    ...
                    <div class="car-actions" style="display: flex; justify-content: space-between; align-items: center; gap: 0.25rem;">
                        <div class="car-price" style="font-size: 1.1rem; font-weight: 700; color: var(--clr-primary); white-space: nowrap;">
                            &euro;${car.price} <span style="font-size: 0.85rem; color: var(--clr-text-light); font-weight: 400;">/ day</span>
                        </div>
                        <button class="btn btn-outline btn-reserve stretched-link" data-brand="${car.brand}" data-model="${car.model}" data-year="${car.year}" style="padding: 0.5rem 1.25rem; font-size: 0.95rem; white-space: nowrap;">Reserve</button>
                    </div>
                </div>
            </div>
        `;
